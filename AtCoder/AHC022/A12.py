...
class Temperature:
    ...
    def init(self):
        ...
        mid_temp = 500
        temp_diff = min(500, round(inp.standard_deviation / 1.6))
        if self.inp.standard_deviation <= 5**2:
            temp_diff = round(inp.standard_deviation * 1.3)
...
if False:
    ...
    for trial in range(n_trial):
        score = solve(TestProblem(L=50, N=100, S=3**2))
